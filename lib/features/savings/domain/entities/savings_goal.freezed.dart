...
mixin _$SavingsGoal {
 ...
 String get id; String get name; double get targetAmount; double get currentAmount; DateTime get deadline; int get colorValue; String get iconName; bool get isCompleted; String get walletId; String? get note; DateTime? get createdAt; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,targetAmount,currentAmount,deadline,colorValue,iconName,isCompleted,walletId,note,createdAt,updatedAt);

@override
String toString() {
  return 'SavingsGoal(id: $id, name: $name, targetAmount: $targetAmount, currentAmount: $currentAmount, deadline: $deadline, colorValue: $colorValue, iconName: $iconName, isCompleted: $isCompleted, walletId: $walletId, note: $note, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, double targetAmount, double currentAmount, DateTime deadline, int colorValue, String iconName, bool isCompleted, String walletId, String? note, DateTime? createdAt, DateTime? updatedAt
});
...
/// Create a copy of SavingsGoal
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? targetAmount = null,Object? currentAmount = null,Object? deadline = null,Object? colorValue = null,Object? iconName = null,Object? isCompleted = null,Object? walletId = null,Object? note = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  double targetAmount,  double currentAmount,  DateTime deadline,  int colorValue,  String iconName,  bool isCompleted,  String walletId,  String? note,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SavingsGoal() when $default != null:
return $default(_that.id,_that.name,_that.targetAmount,_that.currentAmount,_that.deadline,_that.colorValue,_that.iconName,_that.isCompleted,_that.walletId,_that.note,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  double targetAmount,  double currentAmount,  DateTime deadline,  int colorValue,  String iconName,  bool isCompleted,  String walletId,  String? note,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _SavingsGoal():
return $default(_that.id,_that.name,_that.targetAmount,_that.currentAmount,_that.deadline,_that.colorValue,_that.iconName,_that.isCompleted,_that.walletId,_that.note,_that.createdAt,_that.updatedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  double targetAmount,  double currentAmount,  DateTime deadline,  int colorValue,  String iconName,  bool isCompleted,  String walletId,  String? note,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _SavingsGoal() when $default != null:
return $default(_that.id,_that.name,_that.targetAmount,_that.currentAmount,_that.deadline,_that.colorValue,_that.iconName,_that.isCompleted,_that.walletId,_that.note,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _SavingsGoal implements SavingsGoal {
  const _SavingsGoal({required this.id, required this.name, required this.targetAmount, this.currentAmount = 0.0, required this.deadline, required this.colorValue, this.iconName = 'savings', this.isCompleted = false, this.walletId = 'default_wallet', this.note, this.createdAt, this.updatedAt});
